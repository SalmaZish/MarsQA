...
namespace MarsQAProject.Pages
{
    public class MProfilelanguagePage
    {
...

        {
            ...
            {
                Assert.Fail("Error in AddLanguge", ex.Message);
            }
...

        {
            ...
            {
                Assert.Fail("Error in EditLanguge", ex.Message);
            }
        ...
        public void DeleteLanguge(IWebDriver driver,string language, string level)

        {
            ...
            {
                Assert.Fail("Error in DeleteLanguge", ex.Message);
            }
        }
